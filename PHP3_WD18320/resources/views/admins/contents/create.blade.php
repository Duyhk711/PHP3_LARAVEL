                  ...
                  <div class="white_card_body QA_section">
                      <form action="{{ route('sanpham.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                            ...
                            <input
                              id="" name="ma_san_pham" type="text" class="form-control " placeholder="Nhập mã sản phẩm"  
                            />
                          </div>
                        ...
                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                            ...
                            <input
                              id="" name="ten_san_pham" type="text" class="form-control " placeholder="Nhập tên sản phẩm"  
                            />
                          </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="gia" class="form-control" placeholder="Nhập giá sản phẩm" id="">
                        </div>

                        <div class="mb-3">
                            <label for=""  class="form-label">SỐ LƯỢNG</label>
                            <input type="number" min="1" class="form-control" name="so_luong" placeholder="Nhập số lượng sản phẩm" id="">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="ngay_nhap" class="form-control" placeholder="Ngày nhập sản phẩm" id="">
                        </div>
    ...
    <script>
        ...
        if (file) {
            ...
            reader.onload = function (e) {
                img_product.src = e.target.result;
